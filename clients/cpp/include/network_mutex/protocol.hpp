...
inline const char* to_wire(RequestType t) {
  switch (t) {
    ...
    case RequestType::RegisterRead: {
      return "registerRead";
    }
    case RequestType::RegisterWrite: {
      return "registerWrite";
    }
    case RequestType::EndRead: {
      return "endRead";
    }
    case RequestType::EndWrite: {
      return "endWrite";
    }
    case RequestType::LockInfo: {
      return "lockInfo";
    }
    case RequestType::Ls: {
      return "ls";
...
inline std::string version_request(
...
inline std::string lock_request_single(
    const std::string& uuid,
...
inline std::string lock_request_composite(
    const std::string& uuid,
...
inline std::string unlock_request_single(
    const std::string& uuid,
    const std::string& key,
...
inline std::string unlock_request_composite(
    const std::string& uuid,
    const std::vector<std::string>& keys,
    const std::string& lock_uuid) {
  json::Array arr;
