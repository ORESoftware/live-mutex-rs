...
/** Wire protocol mirror with fail-closed fencing admission. */
public final class Protocol {
  ...
  public enum RequestType {
    VERSION("version"), AUTH("auth"), LOCK("lock"), UNLOCK("unlock"),
    REGISTER_READ("registerRead"), REGISTER_WRITE("registerWrite"),
    END_READ("endRead"), END_WRITE("endWrite"), LOCK_INFO("lockInfo"),
    LS("ls"), HEARTBEAT("heartbeat");
    public final String wire;
    RequestType(String wire) { this.wire = wire; }
  }

  public enum ResponseType {
    VERSION("version"), AUTH("auth"), LOCK("lock"), COMPOSITE_LOCK("compositeLock"),
    UNLOCK("unlock"), REGISTER_READ_RESULT("registerReadResult"),
    REGISTER_WRITE_RESULT("registerWriteResult"), END_READ_RESULT("endReadResult"),
    END_WRITE_RESULT("endWriteResult"), LOCK_INFO("lockInfo"), LS_RESULT("lsResult"),
    REELECTION("reelection"), ERROR("error"), OK("ok"), UNKNOWN("");
    public final String wire;
  ...
  private static String frame(Map<String, Object> obj) { return Json.stringify(obj) + "\n"; }

  public static String versionRequest(String uuid, String value) {
    var o = new LinkedHashMap<String, Object>(); o.put("type", RequestType.VERSION.wire); o.put("uuid", uuid); o.put("value", value); return frame(o);
  }
  public static String authRequest(String uuid, String token) {
    var o = new LinkedHashMap<String, Object>(); o.put("type", RequestType.AUTH.wire); o.put("uuid", uuid); o.put("token", token); return frame(o);
  }
  ...
  public static String lockInfoRequest(String uuid, String key) { return rwRequest(RequestType.LOCK_INFO, uuid, key); }
  public static String lsRequest(String uuid) {
    var o = new LinkedHashMap<String, Object>(); o.put("type", RequestType.LS.wire); o.put("uuid", uuid); return frame(o);
  }

  /** Parsed broker frame. Construction validates all authority-bearing success responses. */
  public static final class Response {
    ...
    public static Response parse(String line) { return new Response(Json.parseObject(line)); }
    public String str(String key) { Object v = raw.get(key); return v instanceof String s ? s : ""; }
    public boolean bool(String key) { Object v = raw.get(key); return v instanceof Boolean b && b; }
    public boolean has(String key) { return raw.containsKey(key) && raw.get(key) != null; }
    public long longOr(String key, long def) { Object v = raw.get(key); return v instanceof Long n ? n : def; }
    public boolean acquired() { return bool("acquired"); }
    public boolean unlocked() { return bool("unlocked"); }
    public boolean granted() { return bool("granted"); }
    public String lockUuid() { return str("lockUuid"); }
    public String error() { return str("error"); }

    private static long exactFence(Object v, String field) {
      if (!(v instanceof Long n) || n < 1 || n > MAX_FENCING_TOKEN) {
        throw new IllegalArgumentException(field + " must be an exact fencing token in 1.." + MAX_FENCING_TOKEN);
      }
      return n;
    }
    ...
    private void validateAuthority() {
      if (type == ResponseType.LOCK && acquired()) {
        ...
        for (String key : ks) exactFence(tokens.get(key), "fencingTokens[" + key + "]");
    ...
    public long fencingToken() { return exactFence(raw.get("fencingToken"), "fencingToken"); }
