...
void main() {
  test('LockRequest encodes camelCase fields', () {
    final req = LockRequest(uuid: 'u', keys: ['a', 'b'], ttl: 1000);
    final s = req.encode();
  ...
  test('Response.decode parses compositeLock', () {
    final r = Response.decode('{"type":"compositeLock","uuid":"u","keys":["a","b"],"acquired":true,"lockUuid":"L","fencingTokens":{"a":1,"b":2}}');
